...
def predict_specialty_whole_description(description, target_llm, specialty_str, specialty_list,
    ...
    if llm_backend == "ollama":
        ...
        try:
            r = requests.post(f"{api_config['base_url']}/chat/completions", headers=headers, json=payload)
            r.raise_for_status()
    ...
    ans = find_similar_specialties(specialty_list, response_text, specialty_similarity)
